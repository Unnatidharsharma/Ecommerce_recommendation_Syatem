...
app.config['SQLALCHEMY_DATABASE_URI'] = "mysql://root:@localhost/ecoms"
...
@app.route("/main")
def main():
    # Define or fetch content_based_rec
    content_based_rec = pd.DataFrame()  # Example: Default to an empty DataFrame
